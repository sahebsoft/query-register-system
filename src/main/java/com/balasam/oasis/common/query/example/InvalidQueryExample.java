...
public class InvalidQueryExample {
     ...
     */
    // @Bean  // UNCOMMENT TO TEST - Will fail with: undefined bind parameters: [undefinedParam]
     ...
     */
    // @Bean  // UNCOMMENT TO TEST - Will fail with: undefined bind parameters: [type]
     ...
     */
    // @Bean  // UNCOMMENT TO TEST - Will fail with: Duplicate query definition: 'employees'
     ...
     */
    // @Bean  // UNCOMMENT TO TEST - Will fail with: Duplicate attribute definition: 'salary'
     ...
     */
    // @Bean  // UNCOMMENT TO TEST - Will fail with: Duplicate parameter definition: 'deptId'
     ...
     */
    // @Bean  // UNCOMMENT TO TEST - Will fail with: Duplicate criteria definition: 'statusFilter'
     ...
     */
    // @Bean  // UNCOMMENT TO TEST - Will fail with: duplicate attribute alias/column name
