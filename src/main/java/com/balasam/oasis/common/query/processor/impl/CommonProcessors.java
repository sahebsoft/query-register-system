...
public class CommonProcessors {
    ...
    // Processors
    public static final AttributeFormatter<String> UPPERCASE_PROCESSOR = (value) -> value != null ? value.toUpperCase() : null;

    public static final AttributeFormatter<String> LOWERCASE_PROCESSOR = (value) -> value != null ? value.toLowerCase() : null;
