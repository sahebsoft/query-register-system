 ...
 * Supports simple value processing or complex calculations with row/context access
 */
@FunctionalInterface
public interface Processor {
     ...
     */
    static Processor simple(java.util.function.Function<Object, Object> func) {
     ...
     */
    static Processor mask(String maskValue) {
     ...
     */
    static Processor formatter(java.util.function.Function<Object, String> formatter) {
