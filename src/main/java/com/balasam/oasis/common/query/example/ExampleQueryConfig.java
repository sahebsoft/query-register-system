...
import com.balasam.oasis.common.query.config.GlobalProcessors;
    ...
    public QueryDefinition userDashboardQuery() {
        return QueryDefinitionBuilder.builder("userDashboard")
            ...
            .attribute("email")
                ...
                .filterable(true)
                .sortable(true)
                .validator(CommonProcessors.EMAIL_VALIDATOR::validate)
            ...
            .virtualAttribute("membershipTier")
                ...
                .calculator(obj -> {
                    ...
                    com.balasam.oasis.common.query.core.result.Row row = 
                        (com.balasam.oasis.common.query.core.result.Row) args[1];
                    BigDecimal ltv = row.getBigDecimal("lifetimeValue");
                    if (ltv == null) return "NONE";
            ...
            .criteria("dateFilter")
                ...
                .condition(ctx -> ((com.balasam.oasis.common.query.core.execution.QueryContext) ctx).hasParam("minDate"))
                .build()
