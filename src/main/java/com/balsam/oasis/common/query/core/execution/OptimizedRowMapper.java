...
import com.balsam.oasis.common.query.core.result.RowImpl;
import com.balsam.oasis.common.query.processor.Calculator;
import com.balsam.oasis.common.query.util.TypeConverter;
...
public class OptimizedRowMapper {
     ...
     * This method uses index-based access which is significantly faster than
     * name-based.
     * 
