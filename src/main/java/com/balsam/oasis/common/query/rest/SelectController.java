...
import com.balsam.oasis.common.query.select.SelectDefinition;
import com.balsam.oasis.common.query.select.SelectExecutor;
import com.balsam.oasis.common.query.select.SelectExecution;
import com.balsam.oasis.common.query.select.SelectRegistry;
...
public class SelectController {
    ...
    public ResponseEntity<?> getListOfValues(
        ...
        try {
            ...
            // Execute and return
            LovResponse response = execution.execute();
