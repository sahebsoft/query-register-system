package com.balsam.oasis.common.query.registry;
 ...
 * 
 * <p>This interface is used by components that need to access registered
 * queries but should not be able to modify the registry.</p>
 *
