...
public interface SelectExecution {
     ...
     * Otherwise, the query will be auto-wrapped with WHERE label_column LIKE
     * :search
     * 
     ...
     * 
     * @return this execution for chaining
     * @throws com.balsam.oasis.common.registry.exception.QueryValidationException if
     *                                                                             validation
     *                                                                             fails
     */
     ...
     * @throws com.balsam.oasis.common.registry.exception.QueryExecutionException if
     *                                                                            execution
     *                                                                            fails
     */
    SelectResponse execute();
