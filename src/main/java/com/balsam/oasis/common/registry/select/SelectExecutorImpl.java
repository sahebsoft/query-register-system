    ...
    private class SelectExecutionImpl implements SelectExecution {
        ...
        public SelectResponse execute() {
            try {
                ...
                List<SelectItem> items = jdbcTemplate.query(sql, finalParams, new LovRowMapper());

                return SelectResponse.of(items);
         ...
         */
        private class LovRowMapper implements RowMapper<SelectItem> {
            @Override
