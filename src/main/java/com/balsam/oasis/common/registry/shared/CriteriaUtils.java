package com.balsam.oasis.common.registry.shared;
...
public class CriteriaUtils {
    ...
    public static boolean shouldApplyCriteria(CriteriaDef criteria, 
        ...
        if (criteria.getCondition() != null) {
            ...
            // This is safe because the condition will only be used with appropriate context types
            return ((java.util.function.Predicate<Object>) (java.util.function.Predicate<?>) criteria.getCondition()).test(context);
        }
