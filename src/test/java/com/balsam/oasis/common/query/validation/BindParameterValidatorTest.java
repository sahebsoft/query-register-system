package com.balsam.oasis.common.query.validation;
...
public class BindParameterValidatorTest {
        ...
        void testValidationResult() {
                ...
                BindParameterValidator.ValidationResult result = BindParameterValidator.validateWithDetails(validQuery);
        ...
        void testValidationResultWithError() {
                ...
                BindParameterValidator.ValidationResult result = BindParameterValidator
                                .validateWithDetails(invalidQuery);
