...
class QueryDefinitionBuilderTest {
    ...
    void testBuilderValidationRequiresName() {
        assertThatThrownBy(() -> 
            QueryDefinitionBuilder.builder(null)
                .sql("SELECT * FROM users")
                .attribute("id").build()
                .build()
    ...
    void testBuilderValidationRequiresSql() {
        assertThatThrownBy(() -> 
            QueryDefinitionBuilder.builder("testQuery")
                .attribute("id").build()
                .build()
        ).isInstanceOf(NullPointerException.class)
    ...
    void testAttributeWithAllProperties() {
        ...
        assertThat(attr.isMasked()).isTrue();
    ...
    void testAttributeWithAllowedValues() {
        ...
        assertThat(attr.getDefaultFilterValue()).isEqualTo("USER");
    }
    ...
    @Test
    @DisplayName("Test attribute with processors and formatters")
    void testAttributeWithProcessorsAndFormatters() {
        Function<Object, Object> processor = value -> value.toString().toUpperCase();
        Function<Object, String> formatter = value -> "$" + value;
        Function<Object, Object> converter = value -> new BigDecimal(value.toString());
        Function<Object, Object> calculator = value -> ((BigDecimal) value).multiply(BigDecimal.valueOf(1.1));
        Function<Object, Boolean> validator = value -> value != null && !value.toString().isEmpty();
        ...
        assertThat(attr.getFormatter()).isNotNull();
        assertThat(attr.getConverter()).isNotNull();
        assertThat(attr.getCalculator()).isNotNull();
        assertThat(attr.getValidator()).isNotNull();
        
        // Test the functions work
        assertThat(attr.getProcessor().apply("test")).isEqualTo("TEST");
        assertThat(attr.getFormatter().apply(100)).isEqualTo("$100");
        assertThat(attr.getValidator().apply("value")).isTrue();
        assertThat(attr.getValidator().apply("")).isFalse();
    }
    ...
    void testVirtualAttributeWithDependencies() {
        QueryDefinition query = QueryDefinitionBuilder.builder("testQuery")
            ...
            .virtualAttribute("totalAmount")
                .type(BigDecimal.class)
                .calculator(value -> BigDecimal.valueOf(100))
                .build()
            .build();
    ...
    void testParameterWithValidation() {
        Function<Object, Boolean> validator = value -> 
        ...
        assertThat(param.getValidator()).isNotNull();
        assertThat(param.getValidator().apply(10)).isTrue();
        assertThat(param.getValidator().apply(-5)).isFalse();
    ...
    void testParameterWithConstraints() {
        ...
        assertThat(searchParam.getMinLength()).isEqualTo(3);
        assertThat(searchParam.getMaxLength()).isEqualTo(50);
        assertThat(searchParam.getPattern()).isEqualTo("[a-zA-Z0-9 ]+");
        
        ParamDef pageSizeParam = query.getParams().get("pageSize");
        assertThat(pageSizeParam.getMinValue()).isEqualTo(1);
        assertThat(pageSizeParam.getMaxValue()).isEqualTo(100);
    ...
    void testComplexQueryWithAllFeatures() {
        QueryDefinition query = QueryDefinitionBuilder.builder("complexAnalytics")
            ...
            .attribute("email")
                ...
                .masked(true)
                .secure(ctx -> true)
                .formatter(email -> email.toString().replaceAll("(?<=.{3}).(?=.*@)", "*"))
                .build()
            ...
            .criteria("dateFilter")
                ...
                .condition(ctx -> ((QueryContext) ctx).hasParam("startDate") && ((QueryContext) ctx).hasParam("endDate"))
                .priority(1)
                .build()
            ...
            // Calculators
            .calculator("avgCalculator", (value, row, context) -> {
        ...
        assertThat(query.getRowProcessors()).hasSize(1);
        assertThat(query.getPostProcessors()).hasSize(1);
        assertThat(query.getCalculators()).hasSize(1);
    ...
    void testQueryWithMultipleAttributes() {
        QueryDefinition query = QueryDefinitionBuilder.builder("multiAttributeQuery")
            ...
            .attribute("email").type(String.class).filterable(true).masked(true).build()
            .attribute("phone").type(String.class).masked(true).build()
            ...
            .attribute("isActive").type(Boolean.class).filterable(true).defaultFilterValue(true).build()
            .build();
    ...
    void testBuilderChaining() {
        ...
        QueryDefinition query = QueryDefinitionBuilder.builder("chainTest")
            ...
            .virtualAttribute("virtual1").type(String.class).calculator(v -> "test").build()
            ...
            // Test chaining calculators
            .calculator("calc1", (v, r, c) -> v)
